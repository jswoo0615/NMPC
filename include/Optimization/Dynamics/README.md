...
This directory contains the physical vehicle models and mathematical utilities utilized by both the real-time NMPC solver and the high-fidelity simulator.
